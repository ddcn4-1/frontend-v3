...
type DropdownMenuItemProps = Readonly<React.ComponentProps<typeof DropdownMenuPrimitive.Item>> & {
...
type DropdownMenuLabelProps = Readonly<React.ComponentProps<typeof DropdownMenuPrimitive.Label>> & {
  readonly inset?: boolean;
};
...
type DropdownMenuSubTriggerProps = Readonly<
