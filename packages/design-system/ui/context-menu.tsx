...
type ContextMenuSubTriggerProps = Readonly<
...
type ContextMenuItemProps = Readonly<React.ComponentProps<typeof ContextMenuPrimitive.Item>> & {
  readonly inset?: boolean;
...
type ContextMenuLabelProps = Readonly<React.ComponentProps<typeof ContextMenuPrimitive.Label>> & {
  readonly inset?: boolean;
};
