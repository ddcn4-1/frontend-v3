...
type MenubarItemProps = Readonly<React.ComponentProps<typeof MenubarPrimitive.Item>> & {
...
type MenubarLabelProps = Readonly<React.ComponentProps<typeof MenubarPrimitive.Label>> & {
  readonly inset?: boolean;
};
...
type MenubarSubTriggerProps = Readonly<React.ComponentProps<typeof MenubarPrimitive.SubTrigger>> & {
  readonly inset?: boolean;
};
